...
public static unsafe partial class TSBindings
{
    ...
    [return: NativeTypeName("bool")]
    public static extern byte parser_set_included_ranges(TSParser* self, [NativeTypeName("const TSRange *")] TSRange* ranges, [NativeTypeName("uint32_t")] uint length);
    ...
    public static extern TSRange* parser_included_ranges([NativeTypeName("const TSParser *")] TSParser* self, [NativeTypeName("uint32_t *")] uint* length);
    ...
    public static extern TSNode tree_root_node_with_offset([NativeTypeName("const TSTree *")] TSTree* self, [NativeTypeName("uint32_t")] uint offset_bytes, TSPoint offset_point);
    ...
    public static extern TSRange* tree_included_ranges([NativeTypeName("const TSTree *")] TSTree* param0, [NativeTypeName("uint32_t *")] uint* length);
    ...
    public static extern void tree_print_dot_graph([NativeTypeName("const TSTree *")] TSTree* param0, int file_descriptor);
    ...
    public static extern TSNode node_child_by_field_name(TSNode self, [NativeTypeName("const char *")] sbyte* field_name, [NativeTypeName("uint32_t")] uint field_name_length);
    ...
    public static extern TSNode node_first_named_child_for_byte(TSNode param0, [NativeTypeName("uint32_t")] uint param1);
    ...
    public static extern TSNode node_descendant_for_byte_range(TSNode param0, [NativeTypeName("uint32_t")] uint param1, [NativeTypeName("uint32_t")] uint param2);
    ...
    public static extern TSNode node_named_descendant_for_byte_range(TSNode param0, [NativeTypeName("uint32_t")] uint param1, [NativeTypeName("uint32_t")] uint param2);
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* tree_cursor_current_field_name([NativeTypeName("const TSTreeCursor *")] TSTreeCursor* param0);
    ...
    public static extern ushort tree_cursor_current_field_id([NativeTypeName("const TSTreeCursor *")] TSTreeCursor* param0);
    ...
    public static extern nint tree_cursor_goto_first_child_for_byte(TSTreeCursor* param0, [NativeTypeName("uint32_t")] uint param1);
    ...
    [return: NativeTypeName("uint32_t")]
    public static extern uint query_start_byte_for_pattern([NativeTypeName("const TSQuery *")] TSQuery* param0, [NativeTypeName("uint32_t")] uint param1);
    ...
    public static extern TSQueryPredicateStep* query_predicates_for_pattern([NativeTypeName("const TSQuery *")] TSQuery* self, [NativeTypeName("uint32_t")] uint pattern_index, [NativeTypeName("uint32_t *")] uint* length);
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* query_capture_name_for_id([NativeTypeName("const TSQuery *")] TSQuery* param0, [NativeTypeName("uint32_t")] uint id, [NativeTypeName("uint32_t *")] uint* length);
    ...
    public static extern TSQuantifier query_capture_quantifier_for_id([NativeTypeName("const TSQuery *")] TSQuery* param0, [NativeTypeName("uint32_t")] uint pattern_id, [NativeTypeName("uint32_t")] uint capture_id);
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* query_string_value_for_id([NativeTypeName("const TSQuery *")] TSQuery* param0, [NativeTypeName("uint32_t")] uint id, [NativeTypeName("uint32_t *")] uint* length);
    ...
    public static extern void query_disable_capture(TSQuery* param0, [NativeTypeName("const char *")] sbyte* param1, [NativeTypeName("uint32_t")] uint param2);
    ...
    public static extern void query_cursor_exec(TSQueryCursor* param0, [NativeTypeName("const TSQuery *")] TSQuery* param1, TSNode param2);
    ...
    [return: NativeTypeName("bool")]
    public static extern byte query_cursor_did_exceed_match_limit([NativeTypeName("const TSQueryCursor *")] TSQueryCursor* param0);
    ...
    public static extern void query_cursor_set_match_limit(TSQueryCursor* param0, [NativeTypeName("uint32_t")] uint param1);
    ...
    public static extern void query_cursor_set_byte_range(TSQueryCursor* param0, [NativeTypeName("uint32_t")] uint param1, [NativeTypeName("uint32_t")] uint param2);
    ...
    [return: NativeTypeName("bool")]
    public static extern byte query_cursor_next_capture(TSQueryCursor* param0, TSQueryMatch* match, [NativeTypeName("uint32_t *")] uint* capture_index);
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* language_symbol_name([NativeTypeName("const TSLanguage *")] TSLanguage* param0, [NativeTypeName("TSSymbol")] ushort param1);
    ...
    [return: NativeTypeName("const char *")]
    public static extern sbyte* language_field_name_for_id([NativeTypeName("const TSLanguage *")] TSLanguage* param0, [NativeTypeName("TSFieldId")] ushort param1);
    ...
    [return: NativeTypeName("TSFieldId")]
    public static extern ushort language_field_id_for_name([NativeTypeName("const TSLanguage *")] TSLanguage* param0, [NativeTypeName("const char *")] sbyte* param1, [NativeTypeName("uint32_t")] uint param2);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_language_symbol_type", ExactSpelling = true)]
    public static extern TSSymbolType language_symbol_type([NativeTypeName("const TSLanguage *")] TSLanguage* param0, [NativeTypeName("TSSymbol")] ushort param1);
