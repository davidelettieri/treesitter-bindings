...
public static unsafe partial class TSBindingsParser
{
    ...
    public static extern void parser_set_timeout_micros(TSParser* self, [NativeTypeName("uint64_t")] nuint timeout_micros);
    ...
    public static extern nint tree_cursor_goto_first_child_for_byte(TSTreeCursor* self, [NativeTypeName("uint32_t")] uint goal_byte);
    ...
    [return: NativeTypeName("int64_t")]
    public static extern nint tree_cursor_goto_first_child_for_point(TSTreeCursor* self, TSPoint goal_point);
    ...
    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_language_copy", ExactSpelling = true)]
    [return: NativeTypeName("const TSLanguage *")]
    public static extern TSLanguage* language_copy([NativeTypeName("const TSLanguage *")] TSLanguage* self);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_language_delete", ExactSpelling = true)]
    ...
    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_wasm_store_new", ExactSpelling = true)]
    public static extern TSWasmStore* wasm_store_new(TSWasmEngine* engine, TSWasmError* error);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_wasm_store_delete", ExactSpelling = true)]
    public static extern void wasm_store_delete(TSWasmStore* param0);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_wasm_store_load_language", ExactSpelling = true)]
    [return: NativeTypeName("const TSLanguage *")]
    ...
    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_wasm_store_language_count", ExactSpelling = true)]
    [return: NativeTypeName("size_t")]
    public static extern nuint wasm_store_language_count([NativeTypeName("const TSWasmStore *")] TSWasmStore* param0);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_language_is_wasm", ExactSpelling = true)]
    [return: NativeTypeName("bool")]
    public static extern byte language_is_wasm([NativeTypeName("const TSLanguage *")] TSLanguage* param0);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_parser_set_wasm_store", ExactSpelling = true)]
    public static extern void parser_set_wasm_store(TSParser* param0, TSWasmStore* param1);

    [DllImport("libtree-sitter", CallingConvention = CallingConvention.Cdecl, EntryPoint = "ts_parser_take_wasm_store", ExactSpelling = true)]
